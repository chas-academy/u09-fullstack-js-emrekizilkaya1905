...
export default function PostCard({ post }) {
  return (
    <div className="relative w-full sm:w-[430px] md:w-[300px] lg:w-[350px] border border-gray-300 hover:shadow-lg rounded-lg overflow-hidden transition-shadow duration-300">
